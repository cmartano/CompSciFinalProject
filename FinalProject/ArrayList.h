...
public:
     ...
     */
    void insertAtEnd(std::string itemToAdd);
     ...
     */
    void insertAtFront(std::string itemToAdd);
     ...
     */
    void insertAt(std::string itemToAdd, int index);
     ...
     */
    int findLast(std::string titleToFind);
};
